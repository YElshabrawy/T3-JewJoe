...
const Footer = () => {
  return (
    <div>
      {/* Divider */}
      <div className="md:border-my_gray md:mb-8 md:border-t"></div>
      <div className="md:flex md:items-center md:justify-between">
        ...
        <div className="relative mb-9 md:order-2 md:w-1/3">
          <form>
            ...
            <input
              type="email"
              id="newsletter"
              className="w-full border-b-[1.5px] border-black pb-2 text-sm text-gray-900 focus:ring-0"
              placeholder="Give an email, get the newsletter."
              required
            />
            <button
              type="submit"
              className="absolute right-2.5 bottom-2.5 bg-white py-2"
            >
              <svg
        ...
        {/* Links Info */}
        <ul className="text-my_darkGray mb-5 block space-y-3 md:order-1 md:flex md:items-center md:space-y-0 md:space-x-16">
          <li>
            <h3>CONTACT</h3>
          </li>
          <li>
      ...
      <div className="md:mt-4 md:mb-12 md:flex md:items-center md:justify-between">
        {/* Social Icons */}
        <div className="mb-5 flex items-center space-x-5 md:order-2">
          <Link href="/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="19"
